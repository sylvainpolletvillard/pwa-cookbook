...
Le mot _Progressive_ est une référence à la démarche d'amélioration progressive (**Progressive Enhancement**). Avec le temps, ce mot a pris un sens plus large tout comme _Responsive_ est aujourd'hui utilisé dans d'autres contextes que le _Responsive Web Design_.
